...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Coupons</a> <a href="{{url('/admin/add-coupon')}}" class="current">Add Coupon</a> </div>
    <h1>Coupons</h1>
  </div>
            ...
            <form  class="form-horizontal" method="post" action="{{url('/admin/add-coupon')}}" name="add_coupon" id="add_coupon" > {{csrf_field()}}
              ...
              <div class="control-group">
               ...
               <div class="control-group">
                ...
                <div class="controls">
                  <input style="opacity: 100;" type="checkbox" name="status" id="status" value="1" >
                </div>
              </div> 
