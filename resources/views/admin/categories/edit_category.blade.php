...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Edit Categories</a> <a href="{{url('/admin/edit-category/'.$categoryDetails->id)}} " class="current">Edit Category</a> </div>
    <h1>Categories</h1>
  </div>
