...
<div class="lightbox">
  <div class="iframeContainer">
    ...
    <iframe src="{{ asset('images/frontend_images/loading/Offer.jpg')}}" width="600" height="700" style="border:none;overflow:hidden" scrolling="no" frameborder="0"
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>${{ $product->price }}</h2><p> for each</p>
                      <p style="background-color: white;">{{ $product->product_name }}</p>
